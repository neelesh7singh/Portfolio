...
init('user_YDdVmQQLkBDVwxIzbDaT7');
import AOS from 'aos';
...
const Contact = () => {
  ...
  const submitMessage = (e) => {
    ...
    button.innerHTML = 'Finding Neelesh...';
    button.style.animation = 'bounce 0.75s alternate ease-in-out infinite';
    // console.log(e.target);
    emailjs
      .sendForm('service_41k0dr8', 'template_lj2fyrt', e.target)
      .then((res) => {
      ...
      >
        ...
        <section>
          ...
          <div id='socials'>
            <h1> STALK ME </h1>
            <div>
              <a href='https://www.linkedin.com/in/neelesh7singh/'>
                {' '}
                LINKEDIN{' '}
              </a>
              <a href='https://github.com/neelesh7singh'> GITHUB </a>
            </div>
          </div>
        </section>
      </form>
